export const locale = {
  ...
  data: {
    ...
    DEPOSIT: {
      ...
      depoShow: 'Mostrar',
      DEPOSITTERM: 'Puede hacer un depósito en su capital Survey App enviando Bitcoins (XBT) que se convertirán a EUR y se agregarán a su capital cuando se reciban. Primero, especifique la cantidad que desea depositar; a continuación, se le mostrarán instrucciones sobre cómo completar el depósito en Bitcoins; por favor léalos y sígalos atentamente. ',
      depoEntry: 'entradas',
      depoSearch: 'Buscar',
